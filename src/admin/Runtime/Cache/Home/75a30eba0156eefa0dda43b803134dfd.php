...
//        });
        ...
        $(".pedit").click(function () {     //获取编辑内容
            ...
            var url = "http://" + "<?php echo BASE_URL . "/gmt/src/admin.php/Home/Admin/Role" . "/edit"; ?>";
            $.ajax({
                type: 'POST',
                data: {id: id, act: 1},
                url: url,
        ...
        $(".cartoon-delete").click(function () {
            ...
            show_dialog({
                ...
                submit_callback: function () {
                    ...
                    var id = ele.attr('data-id');
                    var url = "http://" + "<?php echo BASE_URL . "/gmt/src/admin.php/Home/Admin/Role" . "/del"; ?>";
                    $.ajax({
                        type: 'POST',
                        data: {id: id},
                        url: url,
        ...
        $("#save").click(function (event) {
            ...
            // business logic...
            //btn.button('reset')
            var url = "http://" + "<?php echo BASE_URL . "/gmt/src/admin.php/Home/Admin/Role/"; ?>" + url;
            $.ajax({
                type: 'POST',
        ...
        $(".role-user").click(function (event) {
            ...
            var frameSrc = "http://" + "<?php echo BASE_URL . "/gmt/src/admin.php/Home/Admin/Role/"; ?>" + "roleUser/id/" + id;
        ...
        $(".role-permission").click(function (event) {
            ...
            var frameSrc = "http://" + "<?php echo BASE_URL . "/gmt/src/admin.php/Home/Admin/Role/"; ?>" + "rolePermission/id/" + id;
