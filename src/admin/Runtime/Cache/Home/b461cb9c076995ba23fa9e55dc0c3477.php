...
<body>
    ...
    <div class="container">
        ...
        <form class="form-signin">
            <h2 class="form-signin-heading" id='t1'>PayGateway</h2>
    ...
    <script>
        $('#sub').on('click', function (event) {
            ...
            // business logic...
            //btn.button('reset')
            var url = "http://" + "<?php echo BASE_URL . "/PayGateway_v2/src/admin.php/Home/Pub/Login" . "/login"; ?>";
            $.ajax({
                type: 'POST',
                ...
                success: function (data) {
                    if (data) {
                        if (data.code == 1) {
                            ...
                            window.location.href = "http://" + "<?php echo BASE_URL . "/PayGateway_v2/src/admin.php/Home" . "/Index"; ?>";
                        }
                        else {
