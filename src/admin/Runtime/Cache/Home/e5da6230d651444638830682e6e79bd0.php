...
//        });
        ...
        $(".pedit").click(function () {     //获取编辑内容
            ...
            var url = "http://" + "<?php echo BASE_URL . "/gmt/src/admin.php/Home/Gameconfig/Server" . "/edit"; ?>";
            $.ajax({
                type: 'POST',
                data: {id: id,act:1},
                url: url,
        ...
        $(".cartoon-delete").click(function () {
            ...
            show_dialog({
                ...
                submit_callback: function () {
                    ...
                    var id = ele.attr('data-id');
                    var url = "http://" + "<?php echo BASE_URL . "/gmt/src/admin.php/Home/Gameconfig/Server" . "/del"; ?>";
                    $.ajax({
                        type: 'POST',
                        data: {id: id},
                        url: url,
        ...
        $("#save").click(function (event) {
            ...
            // business logic...
            //btn.button('reset')
            var url = "http://" + "<?php echo BASE_URL . "/gmt/src/admin.php/Home/Gameconfig/Server/"; ?>" + url;
            $.ajax({
                type: 'POST',
